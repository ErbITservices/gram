  ...
  async function handleSubmit() {
    ...
    try {
      ...
      const senddata = await fetch(
        `https://gramgranthalay-backend.vercel.app/Motibhaiamin3/${data._id}`,
        {
          method: "PUT",
          headers: {
        ...
        <form className="form " onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <div className="row mb-3 col-sm-13 align-items-center">
              ...
              <div className="col">
                ...
                >
                  ...
                  <option value={0}>15000 થી ઓછું</option>
                  <option value={1}>15001 થી 16,000</option>
                  <option value={2}>16001 થી 17,000</option>
                  <option value={3}>17,001 થી વધુ</option>
                </select>
              </div>
              <div className="col-2">
            ...
            <div className="row mb-3 col-sm-13 align-items-center">
              ...
              <div className="col">
                ...
                >
                  ...
                  <option value={0}>500 થી ઓછું</option>
                  <option value={1}>501 થી 1500</option>
            ...
            <div className="row mb-3 col-sm-13 align-items-center">
              ...
              <div className="col">
                ...
                >
                  ...
                  <option value={3}> 7000 થી વધુ</option>
                  <option value={2}>5000 થી 7000</option>
                  <option value={1}>5,000 થી ઓછા</option>
                </select>
              </div>
              <div className="col-2">
              ...
              <div className="col">
                ...
                >
                  ...
                  <option value={3}>75 થી વધુ ઉમેરાયેલા હોય તો </option>
                  <option value={2}>50 થી 75 પુસ્તકો ઉમેરાયેલ હોય તો</option>
                  <option value={1}>25 થી 50 પુસ્તકો ઉમેરાયેલ હોય તો</option>
                  <option value={0}>25 ઓછા ઉમેરાયેલ હોય તો</option>
                </select>
              </div>
              <div className="col-2">
            ...
            <div className="row mb-3 col-sm-13 align-items-center">
              ...
              <div className="col">
                ...
                >
                  ...
                  <option value={3}>5001થી વધુ</option>
                  <option value={2}>4001થી 5000 </option>
                  <option value={1}>3001થી 4000</option>
                  <option value={0}>3000થી ઓછા હોય તો</option>
                </select>
              </div>
              <div className="col-2">
            ...
            <div className="row mb-3 col-sm-13 align-items-center">
              ...
              <div className="col">
                ...
                >
                  ...
                  <option value={3}>યોગ્ય પદ્ધતિ?</option>
            ...
            <div className="row mb-3 col-sm-13 align-items-center">
              <div className=" col">
                <label className="col-sm-10 col-form-label">
                  પુસ્તકોનું સુચિકરણ કઈ પધ્ધતિથી કરવામાં આવે છે? (કાર્ડપધ્ધતિથી/
                  રજિસ્ટર્ડ પધ્ધતિથી) :
                </label>
              </div>
              <div className="col">
            ...
            <div className="row mb-3 col-sm-13 align-items-center">
              ...
              <div className="col">
                ...
                >
                  ...
                  <option value={2}>૫,૦૦૧ કરતા વધુ</option>
                  <option value={1}>૩૦૦૧ થી ૫૦૦૦ હોય તો</option>
                  <option value={0}>૩૦૦૦ થી ઓછા હોય તો</option>
                </select>
              </div>
              <div className="col-2">
            ...
            <div className="row mb-3 col-sm-13 align-items-center">
              ...
              <div className="col">
                ...
                >
                  ...
                  <option value={1}>3 થી 4 હોય તો</option>
                  <option value={2}>4 થી વધુ</option>
                </select>
              </div>
              <div className="col-2">
              ...
              <div className="col">
                ...
                >
                  ...
                  <option value={0}>2 સામાયિકો</option>
                  <option value={1}>3 થી 4 સામાયિકો</option>
                  <option value={2}>4 થી વધુ</option>
                </select>
              </div>
              <div className="col-2">
            ...
            <div className="row mb-3 col-sm-13 align-items-center">
              ...
              <div className="col">
                ...
                >
                  ...
                  <option value={1}>2001 થી 3000</option>
            ...
            <div className="row mb-3 col-sm-13 align-items-center">
              ...
              <div className=" col">
                <label className="col-sm-10 col-form-label">
                  વાંચનાલયમાં લાભ લેતા વાંચકો ની વાર્ષિક સંખ્યા:
                </label>
              </div>
              <div className="col">
                <select
            ...
            <div className="row mb-3 col-sm-13 align-items-center">
              {/* <div className=" col">
                <label className="col-sm-10 col-form-label">
                  વેકેશનમાં બાળકો માટે અપાતી વિશિષ્ટ સેવાઓ કે થતી પધ્ધતિઓ અંગેની વિગતો:
                </label>
              </div>
              <div className="col">
                <select
            ...
            <div className="row mb-3 col-sm-13 align-items-center">
              ...
              <div className="col">
                ...
                >
                  ...
                  <option value={1}>1રૂ થી 50રૂ </option>
                  <option value={0}>51રૂ થી વધુ </option>
                </select>
              </div>
              <div className="col-2">
              ...
              <div className="col">
                ...
                >
                  ...
                  <option value={1}>૧રૂ થી ૧૦રૂ </option>
                  <option value={0}>૧૦રૂ થી વધુ</option>
                </select>
              </div>
            ...
            <div className="row mb-3 col-sm-13 align-items-center">
              ...
              <div className="col">
                ...
                >
                  ...
                  <option value={2}>વાર્ષિક લવાજમ ૧ થી ૧૦ સુધી લેવાય તો</option>
                  <option value={1}>વાર્ષિક લવાજમ ૧૧ થી ૨૦ હોય તો </option>
                  <option value={0}>વાર્ષિક લવાજમ ૨૧ થી વધુ હોય તો</option>
                </select>
              </div>
              <div className="col-2">
