        ...
        <form className="form " onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <div className="row mb-3 col-sm-13 align-items-center">
              ...
              <div className="col">
                ...
                >
                  ...
                  <option value={0}>5 કલાક થી ઓછા</option>
                </select>
              </div>
              <div className="col-2">
            ...
            <div className="row mb-3 col-sm-13 align-items-center">
              <div className=" col">
                <label className="col-sm-10 col-form-label">
                  ગ્રંથાલયનાં ગ્રંથ સંગ્રહની માહિતી કુલ ગ્રંથ સંખ્યાયા :
                </label>
              </div>
              <div className="col">
                <select
            ...
            <div className="row mb-3 col-sm-13 align-items-center">
              ...
              <div className="col">
                ...
                >
                  ...
                  <option value={0}>૨૦ સામાયિકો</option>
                  <option value={1}>૨૧ થી ૩૦ સામાયિકો</option>
                  <option value={2}>૩૧ થી ૪૦ સામાયિકો</option>
            ...
            <div className="row mb-3 col-sm-13 align-items-center">
              ...
              <div className="col">
                ...
                >
                  ...
                  <option value={1}>10000 થી 15000</option>
                  <option value={2}>15000 થી 20000</option>
            ...
            <div className="row mb-3 col-sm-13 align-items-center">
              ...
              <div className="col">
                ...
                >
                  ...
                  <option value={3}>
                    વર્ષ દરમ્યાન કોઈ પણ સભ્ય રદ ન થતાં હોય તો
                  </option>
                  <option value={2}>
                    વર્ષ દરમ્યાન ૧ થી ૨૦ સભ્યો રદ થયા હોય તો
                  </option>
                  <option value={1}>
                    વર્ષ દરમ્યાન ૨૧ થી ૩૦ સભ્યો રદ થયા હોય તો
                  </option>
                  <option value={0}>
                    વર્ષ દરમ્યાન ૩૦ થી વધુ સભ્યો રદ થયા હોય તો
                  </option>
                </select>
              </div>
              <div className="col-2">
            ...
            <div className="row mb-3 col-sm-13 align-items-center">
              ...
              <div className="col">
                ...
                >
                  ...
                  <option value={0}>1000 સભ્યો થી ઓછા</option>
                </select>
              </div>
              <div className="col-2">
            ...
            <div className="row mb-3 col-sm-13 align-items-center">
              <div className=" col">
                <label className="col-sm-10 col-form-label">
                  • અંધજન ગ્રંથાલયો દ્વારા અપાતી સેવાઓની વિગત (બ્રેઇલ બુક્સ ,
                  ઓડીયો બુક્સ , ડીજીટલ બુક્સ , ઓડીયો કેસેટ , ઓડીયો રેકોર્ડીંગ
                  સુવિધા ):
                </label>
              </div>
              <div className="col">
                ...
                >
                  ...
                  <option value={5}>જો હા તો</option>
                  <option value={2}>ગમે તે એક કે બે</option>
                  <option value={0}>જો ના તો</option>
                </select>
              </div>
              <div className="col-2">
                <h4>{data.select_96}</h4>
              ...
              <div className=" col">
                <label className="col-sm-10 col-form-label">
                  • અંધજન ગ્રંથાલયમાં ઉપયોગમાં લેવાતી અદ્યતન ટેકનોલોજીની
                  સુવિધાની વિગતો( બ્રેઇલ બુક્સ , ઓડીયો બુક્સ , ડીજીટલ બુક્સ ,
                  ઓડીયો કેસેટ , ઓડીયો રેકોર્ડીંગ સુવિધા)
                </label>
              </div>
              <div className="col">
                <select
            ...
            <div className="row mb-3 col-sm-13 align-items-center">
              <div className=" col">
                <label className="col-sm-10 col-form-label">
                  બ્રેઇલ ગ્રંથાલયની સેવાઓ કોમ્પ્યુટરાઇઝ છે?
                </label>
              </div>
              <div className="col">
                <select
              ...
              <div className="col">
                ...
                >
                  ...
                  <option value={5}>અધિકૃત સોફ્ટવેર હોય તો</option>
                  <option value={3}>સેલ્ફમેડ સોફ્ટવેર (પોતાની પધ્ધતિ)</option>
                  <option value={0}> સોફ્ટવેર ન હોય તો </option>
                </select>
              </div>
              <div className="col-2">
                <h4>{data.select_99}</h4>
              </div>
            </div>
            ...
            <div className="row mb-3 col-sm-13 align-items-center">
              <div className=" col">
                <label className="col-sm-10 col-form-label">
                  બ્રેઇલ પુસ્તકો ગ્રંથાલયમાં તૈયાર કરાય છે?
                </label>
              </div>
              <div className="col">
                <select
              ...
              <div className="col-2">
                <h4>{data.select_100}</h4>
              </div>
              <div className=" col">
                <label className="col-sm-10 col-form-label">
                  પ્રજ્ઞાચક્ષુ વાચકો માટે ઓડિયો-વિડિયો વાંચનસામગ્રી ઉપલબ્ધ છે?
                </label>
              </div>
              <div className="col">
                <select
                ...
                >
                  ...
                  <option value={5}>વધુ સારી સેવાઓ હોય તો </option>
                  <option value={3}>મર્યાદિત સેવાઓ હોય તો</option>
                  <option value={0}> ન હોય તો </option>
                </select>
              </div>
              <div className="col-2">
                <h4>{data.select_101}</h4>
              </div>
            </div>
            ...
            <div className="row mb-3 col-sm-13 align-items-center">
              <div className=" col">
                <label className="col-sm-10 col-form-label">
                  પ્રજ્ઞાચક્ષુ વાચકોને અપાતી અનેકવિધ સેવાઓની વિગતવાર માહિતી
                </label>
              </div>
              <div className="col">
                <select
              ...
              <div className="col-2">
                <h4>{data.select_102}</h4>
              </div>
              <div className=" col">
                <label className="col-sm-10 col-form-label">
                  પ્રજ્ઞાચક્ષુ વાચકોને માટે અલગથી રેલિંગ સુવિધા છે તેની વિગતવાર
                  માહિતી.
                </label>
              </div>
              <div className="col">
            ...
            <div className="row mb-3 col-sm-13 align-items-center">
              <div className=" col">
                <label className="col-sm-10 col-form-label">
                  પ્રજ્ઞાચક્ષુ વાચકોને માટે અલગથી શોચાલયની સુવિધા છે તેની
                  વિગતવાર માહિતી.
                </label>
              </div>
              <div className="col">
