  ...
  return (
    <>
      ...
      <form ref={pdfref} onSubmit={handleSubmit} className="form ">
        ...
        <div className="row mb-3 col-sm-13 align-items-center">
          <div className="col-3">
            <label className="col-form-label ">મકાન ની વર્તમાન સ્થિતિ :</label>
          </div>
          <div className="col-2">
            <input
              required
              ...
              <tbody>
                <tr>
                  <td>
                    <div className="row mb-3 col-sm-13 align-items-center">
                      <div className="col">
                        <label className="col-form-label ">૧. લવાજમ :</label>
                      </div>
                      <div className="col">
                        <input
                          required
                    ...
                    <div className="row mb-3 col-sm-13 align-items-center">
                      <div className="col">
                        <label className="col-form-label ">૭. લોક મદદ :</label>
                      </div>
                      <div className="col">
                        <input
                          required
                    ...
                    <div className="row mb-3 col-sm-13 align-items-center">
                      <div className="col">
                        <label className="col-form-label ">૮. અન્ય આવક :</label>
                      </div>
                      <div className="col">
                        <input
                          required
                  ...
                  <td>
                    ...
                    <div className="row mb-3 tab2 col-sm-13 align-items-center">
                      <div className=" col">
                        <label className="tab2 col-form-label ">કુલ :</label>
                      </div>
                      <div className="col">
                        <input
                          required
                    ...
                    <div className="row mb-3 tab col-sm-13 align-items-center">
                      <div className="col">
                        <label className="col-form-label ">૨. મોંઘવારી :</label>
                      </div>
                      <div className="col">
                        <input
                          required
                    ...
                    <div className="row mb-3 tab col-sm-13 align-items-center">
                      <div className="col">
                        <label className="col-form-label ">૧. ફર્નિચર :</label>
                      </div>
                      <div className="col">
                        <input
                          required
                    ...
                    <div className="row mb-3 tab col-sm-13 align-items-center">
                      <div className="col">
                        <label className="col-form-label ">૩. કરવેરા :</label>
                      </div>
                      <div className="col">
                        <input
                          required
